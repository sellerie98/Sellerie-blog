...
In my opinion this payload is the way to go for the first installation.

### GRUB2
You can skip the BIOS/UEFI shenanigans and get right into GRUB on bootup.

The only thing that is a little more complicated that finding a proper menuentry example for secondary payloads that I got from another cb user in the end.
